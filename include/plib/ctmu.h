...
#if	defined (CTMU_V1) || defined (CTMU_V1_1) || defined (CTMU_V2)
/*CTMUCON Control Register*/
 ...
 #elif	defined (CTMU_V1_1) 
 #define CTMU_EDGE1_SOURCE_CCP1        0b00000100 /*CCP1 is a source select for Edge1*/
 #define CTMU_EDGE1_SOURCE_CCP2        0b00000000 /*CCP2 is a source select for Edge1*/
 #endif
 ...
 #elif	defined (CTMU_V1_1)
 #define CTMU_EDGE2_SOURCE_CCP1        0b00000100 /*CCP1 is a source select for Edge1*/
 #define CTMU_EDGE2_SOURCE_CCP2        0b00000000 /*CCP2 is a source select for Edge1*/
 #endif
 ...
 #define CTMU_EDGE2_EDGE_SENSITIVE     0b10000000 /*Input is edge-sensitive*/
 #define CTMU_EDGE2_LEVEL_SENSITIVE    0b00000000 /*Input is level-sensitive*/
 #define CTMU_EDGE2_SENSITIVE_MASK     (~CTMU_EDGE2_EDGE_SENSITIVE)  
 
 #define CTMU_EDGE2_POLARITY_POS       0b01000000 /*Edge 2 programmed for a positive edge response*/
 #define CTMU_EDGE2_POLARITY_NEG       0b00000000 /*Edge 2 programmed for a negative edge response*/
 #define CTMU_EDGE2_POLARITY_MASK      (~CTMU_EDGE2_POS_POLARITY)
 
 #define CTMU_EDGE2_SOURCE_CMP3        0b00001111 /*Edge2 source is Comparator 3 Output*/
 #define CTMU_EDGE2_SOURCE_CMP2        0b00001110 /*Edge2 source is Comparator 2 Output*/
 #define CTMU_EDGE2_SOURCE_CMP1        0b00001101 /*Edge2 source is Comparator 1 Output*/
 #define CTMU_EDGE2_SOURCE_ECCP3       0b00001011 /*Edge2 source is ECCP3 Trigger*/
 #define CTMU_EDGE2_SOURCE_ECCP2       0b00001010 /*Edge2 source is ECCP2 Trigger*/
 #define CTMU_EDGE2_SOURCE_ECCP1       0b00001001 /*Edge2 source is ECCP1 Trigger*/
 #define CTMU_EDGE2_SOURCE_CTED13      0b00001000 /*Edge2 source is CTED10*/
 #define CTMU_EDGE2_SOURCE_CTED12      0b00000111 /*Edge2 source is CTED12*/
 #define CTMU_EDGE2_SOURCE_CTED11      0b00000110 /*Edge2 source is CTED12*/
 #define CTMU_EDGE2_SOURCE_CTED10      0b00000101 /*Edge2 source is CTED10*/
 #define CTMU_EDGE2_SOURCE_CTED9       0b00000100 /*Edge2 source is CTED9*/
 #define CTMU_EDGE2_SOURCE_CTED1       0b00000011 /*Edge2 source is CTED1*/
 #define CTMU_EDGE2_SOURCE_CTED2       0b00000010 /*Edge2 source is CTED2*/
 #define CTMU_EDGE2_SOURCE_ECCP1_INT   0b00000001 /*Edge2 source is ECCP1 Interrupt*/
 #define CTMU_EDGE2_SOURCE_TIMER1      0b00000000 /*Edge2 source is Timer1*/
 #define CTMU_EDGE2_SOURCE_MASK        (~CTMU_EDGE2_SOURCE_CMP3)
 
  /*CTMUCON3 Control Register*/
 #define CTMU_EDGE1_EDGE_SENSITIVE     0b10000000 /*Input is edge-sensitive*/
 #define CTMU_EDGE1_LEVEL_SENSITIVE    0b00000000 /*Input is level-sensitive*/
 #define CTMU_EDGE1_SENSITIVE_MASK     (~CTMU_EDGE1_EDGE_SENSITIVE)  
 
 #define CTMU_EDGE1_POLARITY_POS       0b01000000 /*Edge 1 programmed for a positive edge response*/
 #define CTMU_EDGE1_POLARITY_NEG       0b00000000 /*Edge 1 programmed for a negative edge response*/
 #define CTMU_EDGE1_POLARITY_MASK      (~CTMU_EDGE1_POS_POLARITY)
 
 #define CTMU_EDGE1_SOURCE_CMP3        0b00001111 /*Edge1 source is Comparator 3 Output*/
 #define CTMU_EDGE1_SOURCE_CMP2        0b00001110 /*Edge1 source is Comparator 2 Output*/
 #define CTMU_EDGE1_SOURCE_CMP1        0b00001101 /*Edge1 source is Comparator 1 Output*/
 #define CTMU_EDGE1_SOURCE_ECCP3       0b00001011 /*Edge1 source is ECCP3 Trigger*/
 #define CTMU_EDGE1_SOURCE_ECCP2       0b00001010 /*Edge1 source is ECCP2 Trigger*/
 #define CTMU_EDGE1_SOURCE_ECCP1       0b00001001 /*Edge1 source is ECCP1 Trigger*/
 #define CTMU_EDGE1_SOURCE_CTED13      0b00001000 /*Edge1 source is CTED10*/
 #define CTMU_EDGE1_SOURCE_CTED12      0b00000111 /*Edge1 source is CTED12*/
 #define CTMU_EDGE1_SOURCE_CTED11      0b00000110 /*Edge1 source is CTED12*/
 #define CTMU_EDGE1_SOURCE_CTED10      0b00000101 /*Edge1 source is CTED10*/
 #define CTMU_EDGE1_SOURCE_CTED9       0b00000100 /*Edge1 source is CTED9*/
 #define CTMU_EDGE1_SOURCE_CTED1       0b00000011 /*Edge1 source is CTED1*/
 #define CTMU_EDGE1_SOURCE_CTED2       0b00000010 /*Edge1 source is CTED2*/
 #define CTMU_EDGE1_SOURCE_ECCP1_INT   0b00000001 /*Edge1 source is ECCP1 Interrupt*/
 #define CTMU_EDGE1_SOURCE_TIMER1      0b00000000 /*Edge1 source is Timer1*/
 #define CTMU_EDGE1_SOURCE_MASK        (~CTMU_EDGE1_SOURCE_CMP3)
#endif 
 ...
 #if defined (CTMU_V2)
 #define CTMU_CURR_RANGE_1000_BASE_CURR 0b00000011 /*Current source Range is 1000*Base current (550uA) */
 #define CTMU_CURR_RANGE_100_BASE_CURR  0b00000010 /*Current source Range is 100*Base current (55uA) */
 #define CTMU_CURR_RANGE_10_BASE_CURR   0b00000001 /*Current source Range is 10*Base current (5.5uA)*/
...
Remarks     : None.
**************************************************************************/
#define Enbl_CTMUEdge1  				(CTMUCON4bits.EDG1STAT = 1)
...
Remarks     : None.
**************************************************************************/
#define Enbl_CTMUEdge2 				(CTMUCON4bits.EDG2STAT = 1)
...
Remarks     : None.
**************************************************************************/
#define Disbl_CTMUEdge1 				(CTMUCON4bits.EDG1STAT = 0)
...
Remarks     : None.
**************************************************************************/
#define Disbl_CTMUEdge2				(CTMUCON4bits.EDG2STAT = 0)
...
Remarks     : None.
**************************************************************************/
#define CTMUEdge1_Status      		CTMUCON4bits.EDG1STAT
...
Remarks     : None.
**************************************************************************/
#define CTMUEdge2_Status  	 		CTMUCON4bits.EDG2STAT
